...
class booked_trips(db.Model):
    ...
    b_id = db.Column(db.Integer, db.ForeignKey(
        'bookings.b_id'), primary_key=True)
    c_id = db.Column(db.Integer, db.ForeignKey(
        'customer.c_id'), primary_key=True)
...
class tours(db.Model):
    _tablename_ = 'tours'
    h_id = db.Column(db.Integer, db.ForeignKey('hotel.h_id'),
                     primary_key=True, unique=True, nullable=False)
    cr_id = db.Column(db.Integer, db.ForeignKey(
        'car_rental.cr_id'), primary_key=True, unique=True, nullable=False)
